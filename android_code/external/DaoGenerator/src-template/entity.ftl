...
as ifc>${ifc}<#if ifc_has_next>, </#if></#list></#if> implements Serializable {
...
<#if property.notNull && complexTypes?seq_contains(property.propertyType)>
    ...
    public String toString() {
        return "[${entity.className}]" + <#list entity.properties as property>"${property.propertyName} = " + ${property.propertyName}<#if property_has_next> + ", " + </#if></#list> + "\r\n";
    }
