...
import com.xstd.pirvatephone.activity.AddContactActivity;
import com.xstd.pirvatephone.activity.HandInputActivity;
...
public class ModelAdapter extends CursorAdapter {
	...
	public void bindView(View view, Context context, Cursor cursor) {
		...
		String model_name = cursor.getString(cursor
				.getColumnIndex(ModelDao.Properties.Model_name.columnName));
		int model_type = cursor.getInt(cursor
