...
public class SmsDetailAdapter extends CursorAdapter {
	...
	public void bindView(View view, Context context, Cursor cursor) {
		...
		/*
		 * private Long id; private String phone_number; private String name;
		 * private Long date; private Long duration; private Integer type;
		 */
	...
	public View newView(Context arg0, Cursor arg1, ViewGroup arg2) {
		...
		views.tv_content_in_left = (TextView) view
				.findViewById(R.id.tv_content_in_left);
		views.tv_content_in_right = (TextView) view
				.findViewById(R.id.tv_content_in_right);
