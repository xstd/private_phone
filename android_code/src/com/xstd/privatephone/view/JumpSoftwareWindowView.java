...
public class JumpSoftwareWindowView extends LinearLayout {
    ...
    private WindowManager mWM = (WindowManager) getContext().getSystemService(Context.WINDOW_SERVICE);
    ...
    private void setBackGround(int mode) {
        ...
        float[] outerRadii = new float[]{0, 0, density20, density20, density20, density20, 0, 0};
        ShapeDrawable leftBg = new ShapeDrawable(new RoundRectShape(outerRadii, null, null));
        leftBg.setBounds(0, 0, (int) (70 * mDensity), (int) (35 * mDensity));
        leftBg.getPaint().setColor(0x55000000);


        float[] outerRadiiRight = new float[]{density20, density20, 0, 0, 0, 0, density20, density20};
        ShapeDrawable rightBg = new ShapeDrawable(new RoundRectShape(outerRadiiRight, null, null));
    ...
    private void init() {
        ...
        setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                String packageName = sp.getString("jump_software_package_name", getContext().getPackageName());
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (Math.abs(mPreDownX - event.getRawX()) < distance && Math.abs(mPreDownY - event.getRawY()) < distance) {
                    this.performClick();
                }
    ...
    private void snapToBorder() {
        ...
        mWMParams.x = (mWMParams.x >= (screenWidth >> 1) ? (screenWidth - 100) : 0);
        mWM.updateViewLayout(this, mWMParams);
        setBackGround(mWMParams.x == 0 ? BACK_GROUND_STATE_LEFT : BACK_GROUND_STATE_RIGHT);
    }
