...
public class SmsDetailDaoUtils {
    ...
    public static SmsDetailDao getSmsDetailDao(Context context) {
    	if(sDaoSession == null) {
    		return getDaoSession(context).getSmsDetailDao();
    	}
    	return sDaoSession.getSmsDetailDao();
    }
}
