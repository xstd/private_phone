...
public class PrivacyFileDao extends AbstractDao<PrivacyFile, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Ref_id = new Property(6, Long.class, "ref_id", false, "REF_ID");
    };
    ...
    protected void bindValues(SQLiteStatement stmt, PrivacyFile entity) {
        ...
        Long ref_id = entity.getRef_id();
        if (ref_id != null) {
            stmt.bindLong(7, ref_id);
        }
    }
    ...
    public PrivacyFile readEntity(Cursor cursor, int offset) {
        PrivacyFile entity = new PrivacyFile( //
            ...
            cursor.isNull(offset + 6) ? null : cursor.getLong(offset + 6) // ref_id
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, PrivacyFile entity, int offset) {
        ...
        entity.setRef_id(cursor.isNull(offset + 6) ? null : cursor.getLong(offset + 6));
     }
