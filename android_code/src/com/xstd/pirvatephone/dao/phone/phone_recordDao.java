...
*/
public class phone_recordDao extends AbstractDao<phone_record, Long> {

    public static final String TABLENAME = "PHONE_RECORD";

    /**
     * Properties of entity phone_record.<br/>
    ...
    */
    ...
    public phone_recordDao(DaoConfig config) {
        super(config);
    }
    
    public phone_recordDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'PHONE_RECORD' (" + //
                ...
                "'START_TIME' INTEGER);"); // 4: start_time
    }
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, phone_record entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public phone_record readEntity(Cursor cursor, int offset) {
        phone_record entity = new phone_record( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, phone_record entity, int offset) {
        ...
        entity.setStart_time(cursor.isNull(offset + 4) ? null : cursor.getLong(offset + 4));
     }
    
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(phone_record entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(phone_record entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
